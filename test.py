...
parser.add_argument('--dataset', type=str, default='', help='Path of the validation dataset')# "SOTS"/mnt/dxy/MSBDN-DFF-master/models/MSBDN-DFF-v1-1/1/MSBDN_epoch_50.pkl
parser.add_argument("--checkpoint", default="models/model.pkl", type=str, help="Test on intermediate pkl (default: none)")
...
SR_dir = join(root_val_dir, 'result1-1')  #--------------------------SR results save path处理后的结果的路径
